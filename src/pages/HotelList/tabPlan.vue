<template>
  <section>
    <div class="flex q-pb-md q-gutter-md">
    ...
    <q-table ref="tableRef" class="data-table" v-model:selected="selection" :columns='planColumns' :rows="rows"
      :rows-per-page-options="rowPageOptions" :filter="filter" :filter-method="localFilter" :sort-method="localSorting"
...
import EditDialog from './plan/EditDialog.vue';
