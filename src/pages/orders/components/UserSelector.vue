<template>
  <div>
    ...
    <div class="row q-col-gutter-sm q-mt-none">
      <q-input v-for="column in userColumns" :key="column.name" v-model="model[column.field]" :label="column.label" :rules="column.name == 'id' ? rules.member :[]" class="col-12 col-sm-4" dense outlined readonly hide-bottom-space />
    </div>
  </div>
</template>
