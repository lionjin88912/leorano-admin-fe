<template>
  <div class="flex-1 q-gutter-sm">
    <div class="edit-form-view q-gutter-sm">
      <q-input v-model="mainModel.name" label="國家名稱" hide-bottom-space readonly dense outlined></q-input>
    </div>
    <q-form ref="form" class="edit-form q-gutter-sm">
      <q-input class="edit-form-field full" v-model="model.name" label="國家名稱 *" :rules="rules.name" hide-bottom-space
