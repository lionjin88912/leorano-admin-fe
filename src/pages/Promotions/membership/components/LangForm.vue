<template>
  <div class="flex-1 q-gutter-sm">
    <div class="edit-form-view q-gutter-sm">
      <q-input v-model="mainModel.title" label="活動名稱" hide-bottom-space readonly dense outlined></q-input>
      <q-input v-model="mainModel.desc" label="說明" type="textarea" rows="8" input-style="min-height: 120px;"
        hide-bottom-space readonly dense outlined></q-input>
    </div>
    <q-form ref="form" class="edit-form q-gutter-sm">
      <q-input class="edit-form-field full" v-model="model.title" label="活動名稱 *" :rules="rules.required" hide-bottom-space
        lazy-rules dense outlined></q-input>
      <q-input class="edit-form-field full" v-model="model.desc" label="說明 *" type="textarea" :rules="rules.required"
